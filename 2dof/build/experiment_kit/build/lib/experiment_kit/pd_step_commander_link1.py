...
class PDStepCommander(Node):
    def __init__(self):
        ...
        self.rev1_steps = [2.0, 0.0, 2.0, 0.0,2.0, 4.5, 1.5, 5.0, 3.14]  # Different positions
    ...
    def control_loop(self):
        ...
        if self.time_in_step >= self.step_duration:
            ...
            # Publish zero torque command for the single joint (keep array length 1)
        ...
        ref_msg.data = [ref_pos_rev1, ref_vel_rev1]
