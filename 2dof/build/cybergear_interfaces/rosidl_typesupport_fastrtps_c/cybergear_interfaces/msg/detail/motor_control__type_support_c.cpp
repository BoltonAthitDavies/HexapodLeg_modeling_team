...
#include "cybergear_interfaces/msg/detail/motor_control__rosidl_typesupport_fastrtps_c.h"
...
#include "cybergear_interfaces/msg/detail/set_point__functions.h"  // set_point

// forward declare type support functions
size_t get_serialized_size_cybergear_interfaces__msg__SetPoint(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_cybergear_interfaces__msg__SetPoint(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cybergear_interfaces, msg, SetPoint)();


using _MotorControl__ros_msg_type = cybergear_interfaces__msg__MotorControl;
  ...
  // Field name: set_point
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, cybergear_interfaces, msg, SetPoint
      )()->data);
    if (!callbacks->cdr_serialize(
        &ros_message->set_point, cdr))
    {
      return false;
    }
  }
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_cybergear_interfaces__msg__SetPoint(
...
static uint32_t _MotorControl__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cybergear_interfaces__msg__MotorControl(
  ...
  size_t current_alignment)
{
  ...
  // member: set_point
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_cybergear_interfaces__msg__SetPoint(
  ...
  if (is_plain) {
    ...
    using DataType = cybergear_interfaces__msg__MotorControl;
    is_plain =
      (
...
static size_t _MotorControl__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cybergear_interfaces__msg__MotorControl(
