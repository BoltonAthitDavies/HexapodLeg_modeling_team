...
bool cybergear_interfaces__msg__motor_control__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cybergear_interfaces.msg._motor_control.MotorControl", full_classname_dest, 52) == 0);
  }
  cybergear_interfaces__msg__MotorControl * ros_message = _ros_message;
  {  // motor_id
  ...
  {  // set_point
    ...
    if (!cybergear_interfaces__msg__set_point__convert_from_py(field, &ros_message->set_point)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * cybergear_interfaces__msg__motor_control__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("cybergear_interfaces.msg._motor_control");
  ...
  {  // set_point
    PyObject * field = NULL;
    field = cybergear_interfaces__msg__set_point__convert_to_py(&ros_message->set_point);
    if (!field) {
      return NULL;
    }
    {
