...
#include "cybergear_interfaces/msg/detail/set_point__rosidl_typesupport_fastrtps_c.h"
...
using _SetPoint__ros_msg_type = cybergear_interfaces__msg__SetPoint;
...
static uint32_t _SetPoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cybergear_interfaces__msg__SetPoint(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cybergear_interfaces__msg__SetPoint;
    is_plain =
      (
...
static size_t _SetPoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cybergear_interfaces__msg__SetPoint(
