...
static const _SetPoint_type_support_symbol_names_t _SetPoint_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cybergear_interfaces, msg, SetPoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cybergear_interfaces, msg, SetPoint)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, cybergear_interfaces, msg, SetPoint)() {
  return &::cybergear_interfaces::msg::rosidl_typesupport_c::SetPoint_message_type_support_handle;
}
