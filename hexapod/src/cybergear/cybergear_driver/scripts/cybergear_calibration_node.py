...
import numpy as np
import sys
PATH_TO_PROJECT = "./volta_ws/src/volta_controller/Utils"
sys.path.append(PATH_TO_PROJECT)
from volta_controller.Utils.KinematicsFunc import SolveInverseKinematics
from volta_controller.Utils.UtilsFunc import DefinePlant
